...
# Full Set for Infection Control Nurses (The original set)
ICN_QUESTIONS = [
    {
        "id": 1,
...
# Subset for General Staff Nurses (Focus on core precautions, hygiene, and PPE)
STAFF_NURSE_QUESTIONS = [q for q in ICN_QUESTIONS if q['id'] in [1, 2, 3, 5, 6, 7, 8, 10, 16, 20]]
