...
export const infectionControlAssessment: Assessment = {
  ...
  title: 'Hospital Infection Control Nurse Competency Assessment',
  description: 'A 20-question self-assessment for Hospital Infection Control Nurses to evaluate their knowledge of infection prevention protocols, standard precautions, and disease transmission.',
